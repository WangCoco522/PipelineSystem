...
public class DateUtils {
    ...
    public static Date getLastOfThisMonth(Date date){
        ...
        instance.roll(instance.DAY_OF_MONTH,-1);
    ...
    public static void main(String[] args) {
        try {
            ...
            //System.out.println(parseDate2String(getSundayOfThisWeek()));
            //System.out.println(parseDate2String(getLastOfThisMonth(getToday())));
            String max = parseDate2String(getToday());
            Calendar instance = Calendar.getInstance();//当前系统时间
            instance.add(Calendar.MONTH,-11);
            String min = parseDate2String(instance.getTime());
            List<String> list = getMonthBetween(min, max, "yyyy-MM");
